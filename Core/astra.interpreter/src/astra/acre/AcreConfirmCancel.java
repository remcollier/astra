...
public class AcreConfirmCancel extends AbstractStatement {
	...
	public AcreConfirmCancel(String clazz, int[] data, Term cid) {
	...
	public StatementHandler getStatementHandler() {
		return new StatementHandler() {
			...
			public boolean execute(final Intention context) {
				...
				IACREMessage am = context.getAcreAPI().getConversationManager().confirmCancel( c_id.value() );
			      if ( am != null ) {
